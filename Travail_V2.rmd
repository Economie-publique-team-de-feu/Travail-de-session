...
hist(salbrut,col=bleupale,
    main="Distribution du revenu brut et net", 
     xlab="Revenu annuel ($)", ylab = "Fréquence", ylim = c(0,400))
...
print(thetatry)
print("moments simulés")
print(simhours(thetatry))
print("moments observés")
print(rmoments)
```
...
hist(stats0[,1], main = "Distribution des heures travaillées", 
     xlab = "Fréquence", ylab = "Heures annuelles")
...
```{r fig47, fig.width = 6, fig.height=5}
...
```{r fig48, fig.width = 6, fig.height=5}
#  graphiques en violon
vioplot(stats0[,5],
        stats1[,5],
        stats2[,5],
