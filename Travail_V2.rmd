...
thetatry[10]<- thetatry[10]+150
thetatry[11]<-thetatry[11]+30
```
...
colnames(matstats) <- c("heures travaillées","utilité","revenu brut","taxes et transferts", "revenu net")
summary(matstats)
```
