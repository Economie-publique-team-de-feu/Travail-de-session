...
transferts <- function(inc){
  ...
  if (inc<47527) ((if (inc>9590 & inc<38507) ctps <- min(451, 296+((inc-9590)*0.02)) else ctps <-296) if (inc>38507) ctps <- min(451, 451-((inc-38507)*0.05))) else ctps<-0
  ...
  #total CT
  Crédit TPS/TVH<-ctps+ctc+ctfm+ctce
  
  #Il a été assumé qu'il y avait 1 enfant lorsque applicable.
  ...
  if (inc<199183) ((if (inc>31711 & inc<68708) acece6 <- min(6765, (6765-(inc-31711)*0.07) else acece6 <-6765) (if (inc>68708) acece6 <- min(4175.21, (4175.21-(inc-68708)*0.032) else acece6 <-4175.21) else acece6 <-0
  if (inc<199183) ((if (inc>31711 & inc<68708) acefm6 <- min(6765, (6765-(inc-31711)*0.07) else acefm6 <-6765) (if (inc>68708) acefm6 <- min(4175.21, (4175.21-(inc-68708)*0.032) else acefm6 <-4175.21) else acefm6 <-0
  
  #Enfant de 6 à 17 ans
  if (inc<166152) ((if (inc>31711 & inc<68708) acece17 <- min(5708, (5708-(inc-31711)*0.07) else acece17 <-5708) (if (inc>68708) acece17 <- min(3118.21, (3118.21-(inc-68708)*0.032) else acece17 <-3118.21) else acece17 <-0
  if (inc<166152) ((if (inc>31711 & inc<68708) acefm17 <- min(5708, (5708-(inc-31711)*0.07) else acefm17 <-5708) (if (inc>68708) acefm17 <- min(3118.21, (3118.21-(inc-68708)*0.032) else acefm17 <-3118.21) else acefm17 <-0
  
  #Aucune distinction entre famille monoparentale et couple
  #Un seul des parents reçoit l'allocation, généralement la femme.
