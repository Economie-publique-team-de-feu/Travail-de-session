...
transferts <- function(inc, i){
  ...
  if (ps[i] == 1){
    ...
    if (inc > 3600 & inc < 30217){ # couple
      PrimeTravail[i] <- (0.105*(inc-3600) - max(0, 0.1*(inc-16584))) / 2 # divisé en 2 pour couple
    } else {
      PrimeTravail[i] <- 0
    }
  } else if (ce[i] == 1){
    if (inc > 3600 & inc < 49044){ # couple avec enfant
      PrimeTravail[i] <- (0.25*(inc-3600) - max(0, 0.1*(inc-16584))) / 2 # divisé en 2 pour couple
    } else {
      PrimeTravail[i] <- 0
    }
  ...
  if (ps[i] == 1){
    ...
    if (inc > 3600 & inc < 36308){ # couple
      AllocationTravailleur[i] <- (0.274*(inc-3600) - max(0, 0.2*(inc-18520))) / 2
    } else {
      AllocationTravailleur[i] <- 0
    }
  } else if (ce[i] == 1){
    if (inc > 3600 & inc < 27629){ # couple avec enfant
      AllocationTravailleur[i] <- (0.14*(inc-3600) - max(0, 0.2*(inc-18540))) / 2
    } else {
      AllocationTravailleur[i] <- 0
    }
  }
  ...
  if (fm[i] == 1) {
    ...
    if (inc > 49842) {
      AllocationFamille[i] <- AllocationFamille[i] - 0.04*(inc-49842) # déduction pour haut revenu
    }
  ...
  if (ps[i] == 1) {
    ...
    if (inc > 35400) { # déduction pour revenu élevé
      ...
      CreditSolidarite[i] <- max(0, 2917 + 141 - 0.03*(inc-35400),  CreditSolidarite[i] - 0.06*(inc-35400))
    } 
  } else if (fm[i] == 1) { 
    ...
    if (inc > 35400) { # déduction pour revenu élevé
      # montant versé ne peut pas être inferieur à 0 ou au montant de la composante TVQ
      CreditSolidarite[i] <- max(0, 297 + 297 - 0.03*(inc-35400),  CreditSolidarite[i] - 0.06*(inc-35400)) / 2
