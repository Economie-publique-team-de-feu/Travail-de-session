...
Voici l'histogramme des heures travaillées et des revenus nets et des TMEI. La prime  au travail contribue à augmenter l'emploi, comme il est possible de le voir dans les graphiques (4000 travailleurs à temps plein vs 3000 sans prime au travail). La quantité de gens qui travaillent de 2000 à 2500 heures est également plus élevée que dans le programme de base, ce qui veut dire que le nombre de personnes qui travaillent de 40 heures à 50 heures par semaine a augmenté. De ce fait, plusieurs personnes peuvent bénéficier de la prime: elle semble remplir son objectif. Cela est appuyé par le fait que moins de personnes ont choisi de travailler moins de 1000 heures, bien que cet effet est difficile à évaluer parce qu'il semble minime. De plus, il semble y avoir plus de personnes qui ont un revenu net plus élevé considérant que la distribution des revenus nets est plus asymétrique à droite que dans la situation de base.
...
print(simhours(thetatry))
```
L'ajout de la prime au travail mitige un peu les effets dissuadifs du revenu minimal garanti sur l'offre du travail, avec 19% de personnes ne travaillant pas. 
...
Ensuite, la distribution des revenus nets s'est déplacée pour être centrale autour de 50 000\$, ce qui est beaucoup plus élevé que dans le cas de la situation actuelle. Également, un effet majeur du revenu minimum garanti est qu'il y a un nombre marginal de personnes qui gagnent moins de 20 000\$ par année puisque le transfert minimum du revenu minimum garanti est de 20 333\$ par année. L'effet de la prime au travail se fait peu sentir tant dans la distribution que sur le revenu des individus, ce qui est espéré puisque le transfert du revenu minimum garanti est plus attirant et potentiellement plus élevé que celui pouvant être fourni par la prime au travail, d'autant plus que les individus doivent fournir un effort significatif pour obtenir cette prime, donc pour cette raison son effet est plus faible. 
...
vioplot(stats0[,1],
        stats1[,1],
        stats2[,1],
        stats3[,1], names = c("Base",  "PT","RMG", "RMG et PT"),
...
vioplot(stats0[,5],
        stats1[,5],
        stats2[,5],
        stats3[,5], names = c("Base",  "PT","RMG", "RMG et PT"),
...
legend("bottomright", legend=c("Base", "Prime travail", "Revenu minimum garanti", "RMG et PT"),
...
barplot(listeGini,
        names.arg=c("Base",  "PT", "RMG","RMG et PT"),
