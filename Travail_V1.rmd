...
if(2400<inc<19456) ptps <- 914.11 else ptps <- 0
if(3600<inc<30217) ptc <- 1426.90 else ptc <- 0
if (2400<inc<35680) ptfm <- 2539.2 else ptfm <- 0
if (3600<inc<49044) ptce <- 3303 else ptce <- 0
